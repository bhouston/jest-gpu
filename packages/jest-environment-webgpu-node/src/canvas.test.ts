...
let env: WebgpuEnvironment;
let device: GPUDevice;
let GPUTextureUsage: typeof globalThis.GPUTextureUsage;

beforeAll(async () => {
  env = new WebgpuEnvironment({ projectConfig: { testEnvironmentOptions: {} } as any, globalConfig: {} as any }, {
    console,
    docblockPragmas: {},
