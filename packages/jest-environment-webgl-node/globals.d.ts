/**
 * Types for the globals `jest-environment-webgl-node` installs (node-webgl's `installDOM()`).
 * Pull in with `import 'jest-environment-webgl-node/globals';` from a `.d.ts` your tsconfig includes.
 */
import type {
  Canvas,
  Image as NodeImage,
