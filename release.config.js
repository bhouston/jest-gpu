...
const packages = ['packages/jest-environment-webgl-node', 'packages/jest-environment-webgpu-node'];

export default {
  branches: ['main'],
  repositoryUrl: 'https://github.com/bhouston/jest-gpu.git',
  tagFormat: 'v${version}',
  plugins: [
    ...
    // instead of each package's own tarball. Pack explicitly below, once both
